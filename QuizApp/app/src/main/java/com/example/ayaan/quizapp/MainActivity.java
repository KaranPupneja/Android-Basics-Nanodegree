...
import static com.example.ayaan.quizapp.R.string.question1;
...
//        RadioGroup clickd = (RadioGroup) findViewById(R.id.ques2);
//        int selectdid = clickd.getCheckedRadioButtonId();
//        RadioButton selectedradio = (RadioButton) findViewById(selectdid);
//
//        String s1 = (String) selectedradio.getText();
//        if (s1.equals("Donald Trump")) {
...
//        RadioGroup clickd = (RadioGroup) findViewById(R.id.ques3);
//        int selectdid = clickd.getCheckedRadioButtonId();
//        RadioButton selectedradio = (RadioButton) findViewById(selectdid);
//        String s2 = (String) selectedradio.getText();
//        if (s2.equals("Canberra")) {
